...
const styles = StyleSheet.create({
  ...
  sosText: { color: '#FFFFFF', fontSize: 20, fontWeight: '900', letterSpacing: 1 },
  sosSubtext: { color: 'rgba(255,255,255,0.85)', fontSize: 12, marginTop: 4, fontWeight: '600' },

  cardTitle: { fontSize: 16, fontWeight: '800' },
  cardDesc: { fontSize: 12, marginTop: 2 },

  sectionHeading: { fontSize: 16, fontWeight: '800', marginTop: 14, marginBottom: 8 },
  ...
  cancelChip: { paddingVertical: 8, paddingHorizontal: 16 },
  addChip: { borderRadius: 20, paddingVertical: 8, paddingHorizontal: 16 },
  ...
  guidancePara: { fontSize: 13, lineHeight: 19, marginTop: 8 },
});
