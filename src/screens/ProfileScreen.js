...
const styles = StyleSheet.create({
  ...
  avatarInitial: { color: '#0A0F24', fontSize: 36, fontWeight: '900' },
  verifiedBadge: {
    position: 'absolute',
    bottom: 2,
    right: 2,
  ...
  verifiedText: { color: '#FFFFFF', fontSize: 14, fontWeight: '900' },
  editForm: { width: '100%' },
  fieldLabel: { fontSize: 12, fontWeight: '700', marginBottom: 8, marginTop: 14, letterSpacing: 0.5 },
  userInfo: { alignItems: 'center', width: '100%' },
  name: { fontSize: 24, fontWeight: '900', textAlign: 'center', letterSpacing: -0.5 },
  verifiedPill: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  phoneText: { fontSize: 14, color: '#111827', fontWeight: '700' },
  verifiedPillText: { fontSize: 12, color: '#065F46', fontWeight: '800', textTransform: 'uppercase' },
  email: { fontSize: 15, marginTop: 8, fontWeight: '500' },
  editLink: {
    marginTop: 18,
  ...
  editLinkText: { fontSize: 14, fontWeight: '700' },
  input: {
    borderWidth: 1,
    borderRadius: 14,
    padding: 16,
  ...
  primaryButton: { flex: 1, borderRadius: 14, paddingVertical: 16, alignItems: 'center' },
  primaryButtonText: { color: '#0A0F24', fontWeight: '800', fontSize: 15 },
  secondaryButton: { flex: 1, borderWidth: 1, borderRadius: 14, paddingVertical: 16, alignItems: 'center' },
  secondaryButtonText: { fontWeight: '700', fontSize: 15 },

  metricsContainer: { flexDirection: 'row', gap: 14, marginBottom: 24 },
  metricBox: {
    flex: 1,
    borderRadius: 20,
    padding: 18,
  ...
  metricLabel: { fontSize: 13, fontWeight: '600', marginBottom: 4 },
  ...
  referralHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 },
  cardLabel: { fontSize: 12, fontWeight: '800', letterSpacing: 0.5 },
  referralCode: { fontSize: 26, fontWeight: '900', marginTop: 4, letterSpacing: 1.5 },
  copyCodeButton: {
    paddingHorizontal: 20,
    paddingVertical: 10,
    borderRadius: 14,
  },
  copyCodeButtonText: { color: '#0A0F24', fontWeight: '800', fontSize: 13 },
  cardSub: { fontSize: 13, lineHeight: 19, fontWeight: '500' },

  sectionHeaderRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14, marginTop: 14 },
  sectionTitle: { fontSize: 19, fontWeight: '900', letterSpacing: -0.2 },
  addBtn: { paddingHorizontal: 14, paddingVertical: 8, borderRadius: 14 },
  addLink: { fontSize: 13, fontWeight: '800' },
  addForm: { borderRadius: 20, padding: 20, marginBottom: 20, borderWidth: 1 },
  formLabel: { fontSize: 11, fontWeight: '800', letterSpacing: 0.5, marginBottom: 10, marginTop: 6 },
  labelRow: { flexDirection: 'row', gap: 10, marginBottom: 16 },
  labelChip: { borderWidth: 1, borderColor: '#E5E7EB', borderRadius: 24, paddingVertical: 10, paddingHorizontal: 16 },
  labelChipText: { fontSize: 13, fontWeight: '700', textTransform: 'capitalize' },
  saveAddressBtn: { paddingVertical: 16, borderRadius: 14, alignItems: 'center', marginTop: 10 },
  saveAddressBtnText: { color: '#0A0F24', fontWeight: '800', fontSize: 15 },

  addressesList: { borderRadius: 20, borderWidth: 1, overflow: 'hidden' },
  addressRow: { flexDirection: 'row', alignItems: 'center', padding: 16, gap: 14 },
  addressIconContainer: { width: 40, height: 40, borderRadius: 20, justifyContent: 'center', alignItems: 'center' },
  addressIcon: { fontSize: 18 },
  addressLabel: { fontSize: 14, fontWeight: '900', textTransform: 'uppercase' },
  addressText: { fontSize: 14, marginTop: 2, fontWeight: '500' },
  deleteBtn: { paddingVertical: 6, paddingHorizontal: 10, borderRadius: 10 },
  removeText: { color: '#EF4444', fontSize: 12, fontWeight: '800' },

  emptyState: { borderRadius: 20, borderWidth: 1, padding: 30, alignItems: 'center', gap: 10 },
  emptyIcon: { fontSize: 40 },
  emptyText: { fontSize: 14, textAlign: 'center', lineHeight: 22, fontWeight: '500' },

  menuHeader: { fontSize: 12, fontWeight: '800', letterSpacing: 0.5, marginTop: 28, marginBottom: 12 },
  menuSection: { borderRadius: 20, borderWidth: 1, overflow: 'hidden' },
  menuRow: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingVertical: 16,
  ...
  socialHeader: { fontSize: 12, fontWeight: '800', letterSpacing: 0.5, marginTop: 32, marginBottom: 14, textAlign: 'center' },
  socialRow: { flexDirection: 'row', justifyContent: 'center', gap: 12, marginBottom: 24 },
  socialIconWrap: { width: 48, height: 48, borderRadius: 24, justifyContent: 'center', alignItems: 'center' },

  logoutButton: { borderWidth: 2, borderColor: '#EF4444', borderRadius: 16, paddingVertical: 16, alignItems: 'center', marginTop: 20, marginHorizontal: 4 },
