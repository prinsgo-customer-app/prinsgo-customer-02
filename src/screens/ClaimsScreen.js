...
const styles = StyleSheet.create({
  ...
  sectionHeading: { fontSize: 14, fontWeight: '700', marginHorizontal: 20, marginVertical: 8 },
  emptyLabel: { marginHorizontal: 20, marginVertical: 14, fontSize: 13, fontStyle: 'italic' },
  ...
  bookingType: { fontSize: 10, fontWeight: '800', letterSpacing: 1 },
  bookingId: { fontSize: 14, fontWeight: '700', marginTop: 4 },
  bookingDesc: { fontSize: 12, marginTop: 2, marginBottom: 8 },
  cardFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },

  issueRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginVertical: 10 },
  issueChip: {
    borderWidth: 1,
    borderRadius: 20,
    paddingVertical: 7,
  ...
  claimLabelId: { fontSize: 14, fontWeight: '800' },
  statusPill: { borderRadius: 14, paddingVertical: 4, paddingHorizontal: 10 },
  statusText: { fontSize: 9, fontWeight: '800' },
  divider: { height: 1, marginVertical: 12 },
  refundRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  gstFooter: { textAlign: 'center', fontSize: 10, marginVertical: 10, fontWeight: '600' },
});
